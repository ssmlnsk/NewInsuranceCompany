        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Naimenovanie_dolzhnosti = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
                    Oklad = table.Column<double>(type: "FLOAT", nullable: false),
                    Obyazannosti = table.Column<string>(type: "NVARCHAR(100)", nullable: false),
                    Trebovaniya = table.Column<string>(type: "NVARCHAR(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Naimenovanie = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
                    Opisanie = table.Column<string>(type: "NVARCHAR(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pasportnye_dannye = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
                    Kod_dolzhnosti = table.Column<int>(type: "INT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Naimenovanie = table.Column<string>(type: "NVARCHAR(50)", nullable: false),
                    Opisanie = table.Column<string>(type: "NVARCHAR(100)", nullable: false),
                    Usloviya = table.Column<string>(type: "NVARCHAR(100)", nullable: false),
                    Kod_riska = table.Column<int>(type: "INT", nullable: false)
                },
                constraints: table =>
                {
